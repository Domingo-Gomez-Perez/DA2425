...
(+ 5 3 4)
#|
el resultado es 12 y es lo que se muestra porque se suma primero 5 y 3 y el resultado
...
(+ (* 2 4) (- 4 6))
#|
el resultado es 6 y es lo que muestra porque hace en primer lugar lo que se encuentra
...
#|
El resultado es 19 y es lo que se muestra 
...
(= a b)
#|
Muestra el resultado de la comparación entre a y b,
es decir, compara si 3(a) y 4(b) son iguales, como son distintos
se muestra #f que indica que 3 y 4 no son iguales 
|#
...
Muestra el resultado de la operación AND de los resultados
 de las comparaciones de si b(4)
es mayor que a(3) y comparar si b(4) es menor que el resultado
...
muestra es el valor de b (4), en caso contrario, mostraría el valor de a
|#
...
Compara si a es igual que 4 y como no se cumple pasa
a la otra comparación, es decir, compara si b es igual que 4 y esto
si se cumple, por lo tanto, suma 6, 7 y el valor de a(4);por lo tanto
...
#|
En primer lugar compara si b(4) es mayor que a(3), esto se cumple,
por lo tanto, lo que se obtiene tras esta compración que es el valor
...
Primero compara si a(3) es mayor que b(4), y como no se cumple, pasa
a la otra
comparación en la que se compara si a es menor que b, y esto se cumple,
