...
antes de ejecutarse la función se intentará obtener el valor de los argumentos
...
el valor de x con 0. Probé a usar como argumento p sin los paréntesis y en este caso si me devolvía 0
y no se quedaba en bucle.

Ej:
(test 0 p)

Por otro lado, si se usa el orden normal, lo que pasaría es que como no se intenta obtener los valores
