...
Exercise 1.46: Several of the numerical methods described in this chapter are instances of an extremely general computational strategy known as
...
; va mirando si es suficientemente bueno el resultado y si no se llama con el resultado mejorado
; es un proceso iterativo que no genera pila de llamadas ya que vamos almacenando el guess
...
; ahora hay que cambiar el sqrt y el fixed para esto
...
(define (fixed-point f)
  ...
  ((iterative-improve close-enough? improve) 10))
