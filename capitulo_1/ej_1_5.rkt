...
En orden aplicativo se iniciara un bucle infinito ya que se buscara el valor de (p) de forma recursiva antes 
de comprobar la condición del test.
En caso de forma normal devolverá 0 ya que el primer argumento sera 0 y al revisar el funcionamiento de test 
se comprobara que el segundo argumento es 0 tambien.
