...
(cons x y) ;esta función llamada cons lo que hace es crear una lista de pares con la lista x y la lista y, al ya añadir la lista x, no se puede crear otra lista y con el cons porque hay que considerar el null (ya que cons forma
