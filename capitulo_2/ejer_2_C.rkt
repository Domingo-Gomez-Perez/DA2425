...
(define (width box)
  (cond ((bob-box? box)  (car (cdr (contents box))))
        ((alice-box? box)  (abs (- (car (cdr (contents box)))
                                   (car (car (contents box))))))))

(define (height box)
  (cond ((bob-box? box)  (cdr (cdr (contents box))))
        ((alice-box? box)  (abs (- (cdr (cdr (contents box)))
                                   (cdr (car (contents box))))))))
