;Hecho por David Ruiz, Miguel Martin, Alvaro Gonzalez y Sergio Lanza
...
(define (lookup-variable-value var env)
  (cond
    ...
    [(hash-has-key? env 'base-env) 
     (lookup-variable-value var (hash-ref env 'base-env))]
...
(define (extend-environment vars vals base-env)
  (if (= (length vars) (length vals))
      (let ((new-env (make-hash)))
        ...
        (hash-set! new-env 'base-env base-env) ; Save parent env for lookup
        new-env)
