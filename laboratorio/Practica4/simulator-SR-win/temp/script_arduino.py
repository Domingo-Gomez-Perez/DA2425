...
def loop():
	...
	global seed
	readIRSensor()
	if ((((irSensorValues[0] == NO_LINEA) and (irSensorValues[3] == NO_LINEA)) and (irSensorValues[1] == NO_LINEA)) and (irSensorValues[2] == NO_LINEA)):
		if (randomBit() == 1):
			turnRight()
		else:
			turnLeft()
	elif ((((irSensorValues[0] == LINEA) and (irSensorValues[3] == NO_LINEA)) and (irSensorValues[1] == NO_LINEA)) and (irSensorValues[2] == NO_LINEA)):
		forwardMotor1(EXTRA_FORWARD_TIME)
	elif ((((irSensorValues[0] == NO_LINEA) and (irSensorValues[3] == LINEA)) and (irSensorValues[1] == NO_LINEA)) and (irSensorValues[2] == NO_LINEA)):
		forwardMotor1(EXTRA_FORWARD_TIME)
	else:
		forward()
